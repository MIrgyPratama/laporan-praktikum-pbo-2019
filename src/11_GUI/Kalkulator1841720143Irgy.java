 ...
 * @author ACER
 */
public class Kalkulator1841720143Irgy extends javax.swing.JFrame {
    String bil;
    double jumlah,bil1,bil2;
    int pilih;
    /** Creates new form Kalkulator */
    public Kalkulator1841720143Irgy() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Kalkulator1841720143Irgy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Kalkulator1841720143Irgy().setVisible(true);
            }
        });
    }
