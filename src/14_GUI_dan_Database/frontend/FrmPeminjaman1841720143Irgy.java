...
public class FrmPeminjaman1841720143Irgy extends javax.swing.JFrame {

    /**
     * Creates new form FrmPeminjaman
     */
    public FrmPeminjaman1841720143Irgy() {
        initComponents();
        tampilkanData();
        kosongkanForm();
    }
    ...
    public void tampilkanData(){
        ...
        ArrayList<Peminjaman1841720143Irgy> list = new Peminjaman1841720143Irgy().getAll();
    ...
    public void cariAnggota(String keyword){
        Anggota18411720143Irgy anggota = new Anggota18411720143Irgy().getById(Integer.parseInt(keyword));
        jLabel6.setText("Nama Anggota : "+anggota.getNama());
    }
    
    public void cariBuku(String keyword){
        Buku1841720143Irgy buku = new Buku1841720143Irgy().getById(Integer.parseInt(keyword));
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        Peminjaman1841720143Irgy pmj = new Peminjaman1841720143Irgy();
        pmj.setIdpeminjaman(Integer.parseInt(txtIdPeminjaman.getText()));
        
        Anggota18411720143Irgy anggota = new Anggota18411720143Irgy().getById(Integer.parseInt(txtIdAnggota.getText()));
        Buku1841720143Irgy buku = new Buku1841720143Irgy().getById(Integer.parseInt(txtIdBuku.getText()));
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Peminjaman1841720143Irgy pmj = new Peminjaman1841720143Irgy().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        pmj.delete();
        kosongkanForm();
        tampilkanData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmPeminjaman1841720143Irgy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmPeminjaman1841720143Irgy().setVisible(true);
            }
        });
    }
