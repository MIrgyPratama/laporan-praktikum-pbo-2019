 ...
 * @author mwpras
 */
public class FrmAnggota1841720143Irgy extends javax.swing.JFrame {

    /**
     * Creates new form FrmAnggota
     */
    public FrmAnggota1841720143Irgy() {
        initComponents();
        tampilkanData();
        kosongkanForm();
    }
    ...
    public void tampilkanData() {
        ...
        ArrayList<Anggota18411720143Irgy> list = new Anggota18411720143Irgy().getAll();
        Object rowData[] = new Object[4];
        
        tblAnggota.setModel(new DefaultTableModel(new Object[][] {}, kolom));
        
        for(Anggota18411720143Irgy agt : list) {
    ...
    public void cari(String keyword) {
        String[] kolom = {"ID", "Nama", "Alamat", "Telepon"};
        ArrayList<Anggota18411720143Irgy> list = new Anggota18411720143Irgy().search(keyword);
        Object rowData[] = new Object[4];
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Anggota18411720143Irgy agt = new Anggota18411720143Irgy().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        agt.delete();
        kosongkanForm();
        tampilkanData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmAnggota1841720143Irgy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmAnggota1841720143Irgy().setVisible(true);
            }
        });
    }
